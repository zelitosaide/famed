...
import { updatePublicationAction } from "@/app/lib/actions";
...
export default function EditPublicationForm({ publication, departaments }: any) {
  const initialState = { message: null, errors: {} };
  const updatePublicationWithId = updatePublicationAction.bind(null, publication._id);
  const [state, dispatch] = useFormState(updatePublicationWithId, initialState);
          ...
          <div className="relative mt-2 rounded-md">
            <div className="relative">
              <input
                ...
                name="review"
                type="text"
                defaultValue={publication.review}
            ...
            <div className="flex-1">
              ...
              <div className="relative">
                <select
                  id="department"
                  name="department"
                  defaultValue={publication.department}
                  className="peer block w-full rounded-md border border-gray-200 py-2 pl-10 text-sm outline-2 placeholder:text-gray-500"
                >
              ...
              <div className="relative mt-2 rounded-md">
                <div className="relative">
                  <input
                    ...
                    type="date"
                    defaultValue={publication.publicationDate.split("T")[0]}
                    className="peer block w-full rounded-md border border-gray-200 py-2 pl-10 text-sm outline-2 placeholder:text-gray-500"
