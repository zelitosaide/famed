...
import { createDepartmentAction } from '@/app/lib/actions';
...
export default function CreateDepartmentForm() {
  ...
  const [state, dispatch] = useFormState(createDepartmentAction, initialState);
...
function CreateNewsButton() {
  ...
  return (
    <Button type="submit" aria-disabled={pending}>Criar Departamento</Button>
  );
}
