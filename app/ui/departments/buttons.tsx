...
import { deleteDepartmentAction } from "@/app/lib/actions";
...
export function CreateDepartment() {
  return (
    ...
    >
      <span className="hidden md:block">Criar Departamento</span>{" "}
...
export function DeleteDepartment({ id }: { id: string }) {
  const deleteDepartmentWithId = deleteDepartmentAction.bind(null, id);
  return (
