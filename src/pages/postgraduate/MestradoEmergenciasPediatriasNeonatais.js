export function MestradoEmergenciasPediatriasNeonatais() {
  return (
    <div style={{ paddingTop: '9.5rem' }}>
      <div className='row'>
        ...
        >
          O número máximo de vagas estimado para este curso é de 30. O curso só abrirá se tiver um número mínimo de 15 estudantes.
        </p>
